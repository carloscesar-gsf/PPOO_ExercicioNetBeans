 ...
 */
package br.edu.iftm.sistemaClientes.view;

import br.edu.iftm.sistemaClientes.view.menuItems.MenuItemCliente;
...
public class MenuItems extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        menuItemClientes.setMnemonic('a');
    ...
    private void menuItemClientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuItemClientesActionPerformed
        MenuItemCliente menuItemCliente = new MenuItemCliente();
        menuItemCliente.setVisible(true);
        this.desktopPane.add(menuItemCliente);
